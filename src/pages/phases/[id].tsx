/**
 * @deprecated PÁGINA LEGADA - NÃO USAR
 * Esta página usa o sistema antigo de fases (WORK_PHASES) que está depreciado.
 * Em vez disso, use as novas páginas de categorias que utilizam:
 * - MACHINE_CATEGORIES
 * - WORK_TYPES
 * - CONSTRUCTION_PHASES
 * 
 * Esta página será removida em versões futuras.
 */
