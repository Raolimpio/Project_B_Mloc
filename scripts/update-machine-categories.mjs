...
const CATEGORY_MAPPING = {
  'cat-tipos-trabalho': 'tipoTrabalho',
  'cat-aplicacao': 'aplicacao'
  // Adicione outros mapeamentos se necessário
};

async function updateMachineCategories() {
  try {
    console.log('Iniciando atualização das categorias nas máquinas...');
